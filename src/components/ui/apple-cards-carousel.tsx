  ...
  return (
    <>
      ...
      <motion.button
        layoutId={layout ? `card-${card.title}` : undefined}
        onClick={handleOpen}
        className="group relative z-10 flex h-80 w-56 flex-col items-start justify-start overflow-hidden rounded-3xl bg-gray-100 md:h-[40rem] md:w-96 dark:bg-neutral-900 hover:shadow-2xl hover:shadow-black/25 dark:hover:shadow-primary/20 transition-all duration-300 hover:scale-[1.02] cursor-pointer"
        whileHover={{ y: -8 }}
